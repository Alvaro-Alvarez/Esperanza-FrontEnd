...
@Component({
  selector: 'app-customer-semaphore-stock-moresellers',
  templateUrl: './customer-semaphore-stock-moresellers.component.html',
  styleUrls: ['./customer-semaphore-stock-moresellers.component.scss']
})
export class CustomerSemaphoreStockMoresellersComponent implements OnInit {
