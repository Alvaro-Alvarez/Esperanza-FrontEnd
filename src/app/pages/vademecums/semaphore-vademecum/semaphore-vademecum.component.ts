...
@Component({
  selector: 'app-semaphore-vademecum',
  templateUrl: './semaphore-vademecum.component.html',
  styleUrls: ['./semaphore-vademecum.component.scss']
})
export class SemaphoreVademecumComponent implements OnInit {
